...
public class AdminAnalyticsServiceImpl implements AdminAnalyticsService {
    ...
    public AnalyticsSummaryResponse getSummary(String granularity) {
        ...
        long thisPeriod = clothingItemRepository.countByCreatedAtGreaterThanEqualAndCreatedAtLessThan(
                range.currentStart(), range.currentEnd());
        long lastPeriod = clothingItemRepository.countByCreatedAtGreaterThanEqualAndCreatedAtLessThan(
        ...
        if ("day".equals(period)) {
            ...
            Map<String, Long> hourlyCounts = toCountMap(
                    clothingItemRepository.countHourlySince(todayStart),
                    0
            );
